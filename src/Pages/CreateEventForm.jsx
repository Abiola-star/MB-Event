...
export default function CreateEventForm() {
     ...
     const handleContinue = (e) => {
      ...
      const handleSubmit = async (e) => {
        ...
        try {
          let url = "https://mb-event-backend.onrender.com/api/user/events" || import.meta.env.VITE_EVENT_URL
        ...
        <div className="flex gap-25 py-5">
          ...
          <button
           onClick={handleContinue}
            type="submit"
            className="w-[120px] font-bold rounded-md py-2 px-2 h-[50px] bg-purple-500 text-white hover:bg-purple-900"
