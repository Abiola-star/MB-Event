    ...
    {formData.tags && formData.tags.length > 0 ? (
      ...
      {formData.free ? (
       ...
       <div className="flex gap-25 py-5">
            ...
            onClick={onEdit}
            type="button"
            className="w-[100px] font-bold border-2 rounded-md py-2 px-2 h-[50px] hover:bg-purple-5 hover:border-0 hover:text-white">Edit</motion.button>
                <button
                  type="submit"
                  className="w-[120px] bg-purple-500 hover:bg-purple-800 text-white font-semibold rounded-md"
                >{isLoading ? "Creating Event..." : "Create Event"}</button>
        </div>
    </motion.form>
  );
}