     ...
     <div className="container mx-auto">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-between gap-10 py-5">
        <div className="lg:w-1/2 bg-[#9747FF0F] p-10 rounded-md">
          ...
          <Button content="Join Event" className="w-[200px]" />
        </div>
        ...
        <div className="lg:w-1/2 bg-[#0000000F] p-10 rounded-md">
          ...
          <button className="w-[200px] bg-black text-white h-[50px] rounded-md font-bold transition py-2 px-2 hover:bg-purple-900">Create Event</button>
        </div>
      </div>
     </div>
    </div>
